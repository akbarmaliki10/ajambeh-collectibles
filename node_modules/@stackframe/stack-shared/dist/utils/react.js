...
let __monkey_patch_js = require("./monkey-patch.js");
...
function useRefState(initialValue) {
	...
	const [, setState] = react.default.useState(() => resolvedInitialValue);
	const ref = react.default.useRef(resolvedInitialValue);
	const setValue = react.default.useCallback((updater) => {
...
var NoSuspenseBoundaryError = class extends Error {
	constructor(options) {
		(0, __monkey_patch_js.ensureMonkeyPatch)();
		super(__strings_js.deindent`
    ...
    `);
		this.__noSuspenseBoundarySentinel = __monkey_patch_js.NO_SUSPENSE_BOUNDARY_ERROR_SENTINEL;
...
function suspendIfSsr(caller) {
	if (!(0, __env_js.isBrowserLike)()) throw new NoSuspenseBoundaryError({ caller });
}

//#endregion
exports.NoSuspenseBoundaryError = NoSuspenseBoundaryError;
exports.componentWrapper = componentWrapper;
exports.forwardRefIfNeeded = forwardRefIfNeeded;
exports.getNodeText = getNodeText;
exports.mapRef = mapRef;
exports.mapRefState = mapRefState;
exports.shouldRethrowRenderingError = shouldRethrowRenderingError;
exports.suspend = suspend;
exports.suspendIfSsr = suspendIfSsr;
exports.use = use;
