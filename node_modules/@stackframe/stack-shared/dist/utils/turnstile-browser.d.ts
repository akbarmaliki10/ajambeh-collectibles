...
//#region src/utils/turnstile-browser.d.ts
...
declare function isTurnstileApi(value: unknown): value is TurnstileApi;
declare function getTurnstileApi(): TurnstileApi | undefined;
declare function loadTurnstileScript(): Promise<void>;
//#endregion
export { TurnstileApi, TurnstileAppearance, TurnstileConfig, TurnstileExecution, TurnstileSize, TurnstileTheme, TurnstileWidgetId, getTurnstileApi, isTurnstileApi, loadTurnstileScript };
