...
//#region src/config/db-sync-mappings.ts
const DEFAULT_DB_SYNC_MAPPINGS = { "users": {
	...
	internalDbFetchQueries: { clickhouse: `
        SELECT *
        FROM (
          SELECT
	...
	internalDbFetchQuery: `
      ...
      LIMIT 1000
    `.trim(),
	externalDbUpdateQueries: { postgres: `
        WITH params AS (
          SELECT
            $1::uuid AS "id",
...
//#endregion
exports.DEFAULT_DB_SYNC_MAPPINGS = DEFAULT_DB_SYNC_MAPPINGS;
