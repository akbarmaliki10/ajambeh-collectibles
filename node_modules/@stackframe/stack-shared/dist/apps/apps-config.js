...
const ALL_APP_TAGS = {
	...
	"integration": { displayName: "Integrations" },
	"auth": { displayName: "Authentication" },
	"developers": { displayName: "For Developers" },
	"security": { displayName: "Security" },
	"operations": { displayName: "For Operations" },
	"gtm": { displayName: "Go-to-market" },
	"comms": { displayName: "Communications" },
	"automation": { displayName: "Automation" },
	"storage": { displayName: "Storage & Databases" },
	"various": { displayName: "Various" }
};
const ALL_APPS = {
	"authentication": {
...
//#endregion
exports.ALL_APPS = ALL_APPS;
exports.ALL_APP_TAGS = ALL_APP_TAGS;
