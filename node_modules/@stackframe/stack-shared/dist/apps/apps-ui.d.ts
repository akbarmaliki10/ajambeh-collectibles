...
declare function AppIcon({
  ...
  style,
  cn
}: AppIconProps): react_jsx_runtime0.JSX.Element;
//#endregion
export { AppIcon, AppIconProps, appSquarePaddingExpression, appSquareWidthExpression };
//# sourceMappingURL=apps-ui.d.ts.map