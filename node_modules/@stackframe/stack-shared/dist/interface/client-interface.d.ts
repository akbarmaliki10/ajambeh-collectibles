...
import { a as RegistrationResponseJSON, i as PublicKeyCredentialRequestOptionsJSON, r as PublicKeyCredentialCreationOptionsJSON, t as AuthenticationResponseJSON } from "../index-n9rq7ycX.js";
...
declare class StackClientInterface {
  ...
  sendClientRequest(path: string, requestOptions: RequestInit, session: InternalSession | null, requestType?: "client" | "server" | "admin", apiUrlOverride?: string): Promise<Response & {
    usedTokens: {
  ...
  createCheckoutUrl(customer_type: "user" | "team" | "custom", customer_id: string, productIdOrInline: string | yup.InferType<typeof inlineProductSchema>, session: InternalSession | null, returnUrl?: string, requestType?: "client" | "server" | "admin"): Promise<string>;
...
//#endregion
export { ClientInterfaceOptions, StackClientInterface };
