...
import { yupObject } from "../../schema-fields.js";
import { usersCrudServerReadSchema } from "./users.js";

//#region src/interface/crud/team-member-profiles.ts
const teamMemberProfilesCrudClientReadSchema = yupObject({
...
const teamMemberProfilesCrudServerReadSchema = teamMemberProfilesCrudClientReadSchema.concat(yupObject({ user: usersCrudServerReadSchema.defined() })).defined();
const teamMemberProfilesCrudClientUpdateSchema = yupObject({
...
const teamMemberProfilesCrud = createCrud({
...
//#endregion
export { teamMemberProfilesCrud, teamMemberProfilesCrudClientReadSchema, teamMemberProfilesCrudClientUpdateSchema, teamMemberProfilesCrudServerReadSchema };
