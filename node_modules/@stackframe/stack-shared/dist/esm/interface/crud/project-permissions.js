...
const projectPermissionsCrudServerCreateSchema = yupObject({}).defined();
const projectPermissionsCrudServerDeleteSchema = yupMixed();
const projectPermissionsCrud = createCrud({
...
const projectPermissionCreatedWebhookEvent = {
...
const projectPermissionDeletedWebhookEvent = {
...
const projectPermissionDefinitionsCrudAdminReadSchema = yupObject({
	id: schemaFields.permissionDefinitionIdSchema.defined(),
...
const projectPermissionDefinitionsCrudAdminCreateSchema = yupObject({
...
const projectPermissionDefinitionsCrudAdminUpdateSchema = yupObject({
	id: schemaFields.customPermissionDefinitionIdSchema.optional(),
	description: schemaFields.teamPermissionDescriptionSchema.optional(),
	contained_permission_ids: schemaFields.containedPermissionIdsSchema.optional()
}).defined();
const projectPermissionDefinitionsCrudAdminDeleteSchema = yupMixed();
const projectPermissionDefinitionsCrud = createCrud({
