...
declare const projectsCrudAdminReadSchema: yup.ObjectSchema<{
  ...
  logo_full_url: string | null | undefined;
  logo_dark_mode_url: string | null | undefined;
  logo_full_dark_mode_url: string | null | undefined;
  created_at_millis: number;
  is_production_mode: boolean;
  owner_team_id: string | null;
  onboarding_status: "config_choice" | "apps_selection" | "auth_setup" | "domain_setup" | "email_theme_setup" | "payments_setup" | "completed";
  config: {
    oauth_providers: {
  ...
  logo_url: undefined;
  logo_full_url: undefined;
  logo_dark_mode_url: undefined;
  logo_full_dark_mode_url: undefined;
...
declare const projectsCrudAdminUpdateSchema: yup.ObjectSchema<{
  ...
  onboarding_status: "config_choice" | "apps_selection" | "auth_setup" | "domain_setup" | "email_theme_setup" | "payments_setup" | "completed" | undefined;
  config: {
    oauth_providers?: {
      client_id?: string | undefined;
      client_secret?: string | undefined;
...
declare const clientProjectsCrud: ______crud0.CrudSchemaFromOptions<{
...
declare const projectsCrud: ______crud0.CrudSchemaFromOptions<{
...
declare const adminUserProjectsCrud: ______crud0.CrudSchemaFromOptions<{
  clientReadSchema: yup.ObjectSchema<{
    id: string;
    display_name: string;
    description: string;
