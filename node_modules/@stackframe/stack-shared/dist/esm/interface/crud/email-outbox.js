...
//#region src/interface/crud/email-outbox.ts
...
const recipientSchema = fieldSchema.yupUnion(recipientUserPrimaryEmailSchema, recipientUserCustomEmailsSchema, recipientCustomEmailsSchema);
...
const startedSendingFieldsSchema = renderedFieldsSchema.concat(fieldSchema.yupObject({ started_sending_at_millis: fieldSchema.yupNumber().defined() }).defined());
...
const emailOutboxReadSchema = fieldSchema.yupUnion(pausedStatusSchema, preparingStatusSchema, renderingStatusSchema, renderErrorStatusSchema, scheduledStatusSchema, queuedStatusSchema, sendingStatusSchema, serverErrorStatusSchema, skippedStatusSchema, bouncedStatusSchema, deliveryDelayedStatusSchema, sentStatusSchema, openedStatusSchema, clickedStatusSchema, markedAsSpamStatusSchema);
const emailOutboxUpdateSchema = fieldSchema.yupObject({
...
const emailOutboxCrud = createCrud({
...
//#endregion
export { emailOutboxCrud, emailOutboxReadSchema, emailOutboxUpdateSchema };
