...
//#region src/interface/crud/email-templates.d.ts
type EmailTemplateType = typeof emailTemplateTypes[number];
declare const emailTemplateTypes: readonly ["email_verification", "password_reset", "magic_link", "team_invitation", "sign_in_invitation", "payment_receipt", "payment_failed"];
declare const emailTemplateAdminReadSchema: yup.ObjectSchema<{
  type: "email_verification" | "password_reset" | "magic_link" | "team_invitation" | "sign_in_invitation" | "payment_receipt" | "payment_failed";
  subject: string;
  content: {} | null;
  is_default: boolean;
}, yup.AnyObject, {
...
declare const emailTemplateCrud: ______crud0.CrudSchemaFromOptions<{
...
//#endregion
export { EmailTemplateCrud, EmailTemplateType, emailTemplateAdminReadSchema, emailTemplateCrud, emailTemplateCrudAdminCreateSchema, emailTemplateCrudAdminDeleteSchema, emailTemplateCrudAdminUpdateSchema, emailTemplateTypes };
