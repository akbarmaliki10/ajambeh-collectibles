...
//#region src/interface/crud/users.d.ts
declare const riskScoreFieldSchema: yup.NumberSchema<number, yup.AnyObject, undefined, "">;
declare const signUpRiskScoresSchema: yup.ObjectSchema<{
  sign_up: {
    bot: number;
  ...
  sign_up: {
    bot: undefined;
    free_trial_abuse: undefined;
  };
}, "">;
type SignUpRiskScoresCrud = InferType<typeof signUpRiskScoresSchema>["sign_up"];
...
declare const usersCrud: ______crud0.CrudSchemaFromOptions<{
...
declare const userCreatedWebhookEvent: WebhookEvent<yup.ObjectSchema<{
  id: string;
  primary_email: string | null;
  primary_email_verified: boolean;
  primary_email_auth_enabled: boolean;
...
declare const userUpdatedWebhookEvent: WebhookEvent<yup.ObjectSchema<{
  id: string;
  primary_email: string | null;
  primary_email_verified: boolean;
  primary_email_auth_enabled: boolean;
...
declare const userDeletedWebhookEvent: WebhookEvent<yup.ObjectSchema<{
  id: string;
  teams: {
    id: string;
  }[];
