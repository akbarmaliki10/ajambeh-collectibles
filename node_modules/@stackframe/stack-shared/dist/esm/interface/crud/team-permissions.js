...
//#region src/interface/crud/team-permissions.ts
const teamPermissionsCrudClientReadSchema = yupObject({
...
const teamPermissionsCrudServerCreateSchema = yupObject({}).defined();
const teamPermissionsCrudServerDeleteSchema = yupMixed();
const teamPermissionsCrud = createCrud({
...
const teamPermissionCreatedWebhookEvent = {
...
const teamPermissionDeletedWebhookEvent = {
...
const teamPermissionDefinitionsCrudAdminReadSchema = yupObject({
	id: schemaFields.permissionDefinitionIdSchema.defined(),
...
const teamPermissionDefinitionsCrudAdminCreateSchema = yupObject({
...
const teamPermissionDefinitionsCrudAdminUpdateSchema = yupObject({
	id: schemaFields.customPermissionDefinitionIdSchema.optional(),
	description: schemaFields.teamPermissionDescriptionSchema.optional(),
	contained_permission_ids: schemaFields.containedPermissionIdsSchema.optional()
}).defined();
const teamPermissionDefinitionsCrudAdminDeleteSchema = yupMixed();
const teamPermissionDefinitionsCrud = createCrud({
...
//#endregion
export { teamPermissionCreatedWebhookEvent, teamPermissionDefinitionsCrud, teamPermissionDefinitionsCrudAdminCreateSchema, teamPermissionDefinitionsCrudAdminDeleteSchema, teamPermissionDefinitionsCrudAdminReadSchema, teamPermissionDefinitionsCrudAdminUpdateSchema, teamPermissionDeletedWebhookEvent, teamPermissionsCrud, teamPermissionsCrudClientReadSchema, teamPermissionsCrudServerCreateSchema, teamPermissionsCrudServerDeleteSchema };
