...
import { teamsCrudClientReadSchema } from "./teams.js";
import { usersCrudServerDeleteSchema, usersCrudServerReadSchema, usersCrudServerUpdateSchema } from "./users.js";

//#region src/interface/crud/current-user.ts
...
]).concat(yupObject({ selected_team: teamsCrudClientReadSchema.nullable().defined() })).defined();
const serverReadSchema = usersCrudServerReadSchema.defined();
const clientDeleteSchema = usersCrudServerDeleteSchema;
const currentUserCrud = createCrud({
	clientReadSchema,
	serverReadSchema,
	clientUpdateSchema,
	serverUpdateSchema,
