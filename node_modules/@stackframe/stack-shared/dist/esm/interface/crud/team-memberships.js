...
import { yupMixed, yupObject, yupString } from "../../schema-fields.js";

//#region src/interface/crud/team-memberships.ts
const teamMembershipsCrudClientReadSchema = yupObject({
	team_id: yupString().defined(),
	user_id: yupString().defined()
}).defined();
const teamMembershipsCrudServerCreateSchema = yupObject({}).defined();
const teamMembershipsCrudClientDeleteSchema = yupMixed();
const teamMembershipsCrud = createCrud({
...
const teamMembershipCreatedWebhookEvent = {
...
const teamMembershipDeletedWebhookEvent = {
...
//#endregion
export { teamMembershipCreatedWebhookEvent, teamMembershipDeletedWebhookEvent, teamMembershipsCrud, teamMembershipsCrudClientDeleteSchema, teamMembershipsCrudClientReadSchema, teamMembershipsCrudServerCreateSchema };
