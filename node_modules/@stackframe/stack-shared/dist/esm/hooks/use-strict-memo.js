...
function unwrapFromInner(dependencies, inner) {
	if (dependencies.length === 0 !== "isNotNestedMap" in inner) return Result.error(void 0);
	if ("isNotNestedMap" in inner) if (dependencies.length === 0) return Result.ok(inner.value);
	else return Result.error(void 0);
	else if (dependencies.length === 0) return Result.error(void 0);
	else {
