...
import { Currency } from "./utils/currency-constants";
import { DayInterval, Interval } from "./utils/dates";
import { ISO_3166_ALPHA_2_COUNTRY_CODES, isValidCountryCode, normalizeCountryCode, validCountryCodeSet, validateCountryCode } from "./utils/country-codes";
...
declare function yupTuple<T extends [unknown, ...unknown[]]>(schemas: { [K in keyof T]: yup.Schema<T[K]> }): yup.TupleSchema<T | undefined, yup.AnyObject, undefined, "">;
...
declare const wildcardProtocolAndDomainSchema: yup.StringSchema<string | undefined, yup.AnyObject, undefined, "">;
...
declare const countryCodeSchema: yup.StringSchema<string | undefined, yup.AnyObject, undefined, "">;
...
declare const projectLogoFullUrlSchema: yup.StringSchema<string | undefined, yup.AnyObject, undefined, "">;
declare const projectLogoDarkModeUrlSchema: yup.StringSchema<string | undefined, yup.AnyObject, undefined, "">;
declare const projectLogoFullDarkModeUrlSchema: yup.StringSchema<string | undefined, yup.AnyObject, undefined, "">;
...
declare const projectOnboardingStatusValues: readonly ["config_choice", "apps_selection", "auth_setup", "domain_setup", "email_theme_setup", "payments_setup", "completed"];
type ProjectOnboardingStatus = typeof projectOnboardingStatusValues[number];
declare const projectOnboardingStatusSchema: yup.StringSchema<"config_choice" | "apps_selection" | "auth_setup" | "domain_setup" | "email_theme_setup" | "payments_setup" | "completed" | undefined, yup.AnyObject, undefined, "">;
...
declare const oauthAppleBundleIdsSchema: yup.ArraySchema<string[] | undefined, yup.AnyObject, undefined, "">;
declare const oauthAppleBundleIdSchema: yup.StringSchema<string, yup.AnyObject, undefined, "">;
...
declare const customDashboardsSchema: yup.MixedSchema<Record<string, {
  displayName: string;
  tsxSource: string;
}>, yup.AnyObject, undefined, "">;
declare const customerTypeSchema: yup.StringSchema<"user" | "team" | "custom" | undefined, yup.AnyObject, undefined, "">;
declare const productPriceSchema: yup.ObjectSchema<{
...
declare const productClientMetadataSchema: yup.MixedSchema<{} | null, yup.AnyObject, undefined, "">;
declare const productClientReadOnlyMetadataSchema: yup.MixedSchema<{} | null, yup.AnyObject, undefined, "">;
...
declare const inlineProductSchema: yup.ObjectSchema<{
  display_name: string;
...
declare const restrictedReasonSchema: yup.ObjectSchema<{
  type: "anonymous" | "email_not_verified" | "restricted_by_administrator";
}, yup.AnyObject, {
  type: undefined;
}, "">;
type RestrictedReason = yup.InferType<typeof restrictedReasonSchema>;
