...
type CrudSchemaCreationOptions = { [K in AccessTypeXCrudOperation as `${K}Schema`]?: yup.AnySchema };
type FillInOptionalsPrepareStep<O extends CrudSchemaCreationOptions> = { [K in keyof Required<CrudSchemaCreationOptions>]: K extends keyof O ? O[K] : undefined };
...
type CrudDocsCreationOptions<SO extends CrudSchemaCreationOptions> = { [X in AccessTypeXCrudlOperation]?: EndpointDocumentation };
...
//#endregion
export { AccessType, AccessTypeXCrudOperation, AccessTypeXCrudlOperation, CrudOperation, CrudSchema, CrudSchemaCreationOptions, CrudSchemaFromOptions, CrudTypeOf, CrudlOperation, EndpointDocumentation, createCrud };
