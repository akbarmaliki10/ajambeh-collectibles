//#region src/apps/apps-config.d.ts
...
declare const ALL_APPS: {
  ...
  readonly onboarding: {
    ...
    readonly subtitle: "Configure user onboarding requirements";
    readonly tags: ["auth"];
  ...
  readonly analytics: {
    ...
    readonly subtitle: "View and explore analytics data";
    readonly tags: ["developers", "operations"];
    readonly stage: "beta";
  };
};
//#endregion
export { ALL_APPS, ALL_APP_TAGS, AppId };
