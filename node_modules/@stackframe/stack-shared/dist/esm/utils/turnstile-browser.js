...
function loadTurnstileScript() {
	if (typeof window === "undefined") return Promise.reject(new StackAssertionError("Turnstile can only be loaded in the browser"));
...
//#endregion
export { getTurnstileApi, isTurnstileApi, loadTurnstileScript };
