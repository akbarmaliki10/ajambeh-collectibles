...
const ISO_3166_ALPHA_2_COUNTRY_CODES = [
	"AD",
	"AE",
	"AF",
	"AG",
...
const validCountryCodeSet = new Set(ISO_3166_ALPHA_2_COUNTRY_CODES);
...
function validateCountryCode(value) {
	...
	return values.every((v) => isValidCountryCode(v)) ? null : "Country code must be a valid ISO 3166-1 alpha-2 code";
}
...
//#endregion
export { ISO_3166_ALPHA_2_COUNTRY_CODES, isValidCountryCode, normalizeCountryCode, validCountryCodeSet, validateCountryCode };
