...
declare function decodeBase32(input: string): Uint8Array<ArrayBuffer>;
declare function encodeBase64(input: Uint8Array): string;
declare function decodeBase64(input: string): Uint8Array<ArrayBuffer>;
declare function encodeBase64Url(input: Uint8Array): string;
declare function decodeBase64Url(input: string): Uint8Array<ArrayBuffer>;
declare function decodeBase64OrBase64Url(input: string): Uint8Array<ArrayBuffer>;
