...
function validateBase64Image(base64) {
	return /^data:image\/(png|jpg|jpeg|gif|bmp|webp);base64,[A-Za-z0-9+/]+={0,2}$|^[A-Za-z0-9+/]+={0,2}$/.test(base64);
}
(void 0)?.test("validateBase64Image", ({ expect }) => {
