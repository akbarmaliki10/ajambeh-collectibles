...
async function createNodeHttpServerDuplex(options) {
	const incomingMessage = new IncomingMessage({ encrypted: options.originalUrl?.protocol === "https:" });
