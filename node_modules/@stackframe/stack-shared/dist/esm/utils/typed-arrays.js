...
function toArrayBufferBacked(arr) {
	if (arr.buffer instanceof SharedArrayBuffer) throw new StackAssertionError("SharedArrayBuffer-backed Uint8Arrays are not supported in this context");
	return new Uint8Array(arr.buffer, arr.byteOffset, arr.byteLength);
}

//#endregion
export { toArrayBufferBacked };
