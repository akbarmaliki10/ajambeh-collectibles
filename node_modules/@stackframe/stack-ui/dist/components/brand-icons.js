...
function Microsoft({ iconSize }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
		...
		viewBox: "0 0 21 21",
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("title", { children: "MS-SymbolLockup" }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
				fill: "#f25022",
				d: "M1 1h9v9H1z"
			}),
...
function Gitlab({ iconSize }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("g", { children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
...
function Bitbucket({ iconSize }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
		...
		width: iconSize,
		height: iconSize,
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("linearGradient", {
			id: "a",
			x1: "108.633%",
			x2: "46.927%",
			y1: "13.818%",
			...
			fill: "none",
			children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M101.272 152.561h53.449l12.901-75.32H87.06z" }),
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
...
function Apple({ iconSize }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M15.769,0c0.053,0,0.106,0,0.162,0c0.13,1.606-0.483,2.806-1.228,3.675c-0.731,0.863-1.732,1.7-3.351,1.573c-0.108-1.583,0.506-2.694,1.25-3.561C13.292,0.879,14.557,0.16,15.769,0z" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M20.67,16.716c0,0.016,0,0.03,0,0.045c-0.455,1.378-1.104,2.559-1.896,3.655c-0.723,0.995-1.609,2.334-3.191,2.334c-1.367,0-2.275-0.879-3.676-0.903c-1.482-0.024-2.297,0.735-3.652,0.926c-0.155,0-0.31,0-0.462,0c-0.995-0.144-1.798-0.932-2.383-1.642c-1.725-2.098-3.058-4.808-3.306-8.276c0-0.34,0-0.679,0-1.019c0.105-2.482,1.311-4.5,2.914-5.478c0.846-0.52,2.009-0.963,3.304-0.765c0.555,0.086,1.122,0.276,1.619,0.464c0.471,0.181,1.06,0.502,1.618,0.485c0.378-0.011,0.754-0.208,1.135-0.347c1.116-0.403,2.21-0.865,3.652-0.648c1.733,0.262,2.963,1.032,3.723,2.22c-1.466,0.933-2.625,2.339-2.427,4.74C17.818,14.688,19.086,15.964,20.67,16.716z" })]
	});
}
function X({ iconSize }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
...
function Twitch({ iconSize }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
		...
		height: iconSize,
		xmlns: "http://www.w3.org/2000/svg",
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("g", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("polygon", {
			fill: "#FFFFFF",
			points: "2200,1300 1800,1700 1400,1700 1050,2050 1050,1700 600,1700 600,200 2200,200"
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("g", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("g", {
			id: "Layer_1-2",
			children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
					fill: "#9146FF",
...
function Mapping({ provider, iconSize }) {
	switch (provider) {
		case "google": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Google, { iconSize });
		case "github": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(GitHub, { iconSize });
		case "facebook": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Facebook, { iconSize });
		case "microsoft": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Microsoft, { iconSize });
		case "spotify": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Spotify, { iconSize });
		case "discord": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Discord, { iconSize });
		case "gitlab": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Gitlab, { iconSize });
		case "bitbucket": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Bitbucket, { iconSize });
		case "linkedin": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LinkedIn, { iconSize });
		case "apple": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Apple, { iconSize });
		case "x": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(X, { iconSize });
		case "twitch": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Twitch, { iconSize });
		default: throw new _stackframe_stack_shared_dist_utils_errors.StackAssertionError(`Icon not found for provider: ${provider}`);
	}
}
function toTitle(id) {
	return {
		...
		x: "X",
		twitch: "Twitch"
	}[id] || (0, _stackframe_stack_shared_dist_utils_errors.throwErr)(`Unknown provider: ${id}`);
}
const BRAND_COLORS = {
	github: "#24292e",
	google: "#ffffff",
