...
function constructRedirectUrl(redirectUrl, callbackUrlName) {
	if (typeof window === "undefined" || !window.location) throw new _stackframe_stack_shared_dist_utils_errors.StackAssertionError(`${callbackUrlName} option is required in a non-browser environment.`, { redirectUrl });
...
//#endregion
exports.constructRedirectUrl = constructRedirectUrl;
