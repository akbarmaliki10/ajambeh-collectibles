...
//#region src/components/profile-image-editor.tsx
async function checkImageUrl(url) {
	try {
		return (await (await fetch(url, { method: "HEAD" })).blob()).type.startsWith("image/");
	} catch (e) {
		return false;
	}
}
		...
		input.onchange = (e) => {
			...
			runAsynchronouslyWithAlert(async () => {
				...
				if (await checkImageUrl(rawUrl)) {
					setRawUrl(rawUrl);
					setError(null);
				} else setError(t("Invalid image"));
				input.remove();
			});
		};
		input.click();
	}
	if (!rawUrl) return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx(UserAvatar, {
				...
				children: /* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsx(Upload, { className: "h-5 w-5" })
				})
			})]
				...
				children: [/* @__PURE__ */ jsx(Button, {
					onClick: async () => {
						if (rawUrl && croppedAreaPixels) {
							...
							if (croppedImageUrl) {
								const compressedFile = await imageCompression(await imageCompression.getFilefromDataUrl(croppedImageUrl, "profile-image"), {
									maxSizeMB: .1,
									fileType: "image/jpeg"
								});
								...
								reset();
							} else setError(t("Could not crop image."));
						}
					},
					children: t("Save")
				}), /* @__PURE__ */ jsx(Button, {
...
//#endregion
export { ProfileImageEditor, checkImageUrl, getCroppedImg };
