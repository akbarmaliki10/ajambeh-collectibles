...
function toolbarRender(table) {
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(SearchToolbarItem, {
		table,
		placeholder: "Search table"
	}), /* @__PURE__ */ jsx(DataTableFacetedFilter, {
...
function RevokeDialog(props) {
	return /* @__PURE__ */ jsx(ActionDialog, {
		open: props.open,
...
function Actions({ row }) {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(RevokeDialog, {
		apiKey: row.original,
		open: isRevokeModalOpen,
		onOpenChange: setIsRevokeModalOpen
	}), /* @__PURE__ */ jsx(ActionCell, {
...
const columns = [
	{
		...
		cell: ({ row }) => /* @__PURE__ */ jsx(TextCell, {
			size: 100,
	...
	},
	{
		...
		cell: ({ row }) => /* @__PURE__ */ jsxs(TextCell, { children: ["*******", row.original.value.lastFour] }),
		enableSorting: false
	},
	{
		...
		cell: ({ row }) => {
			...
			return row.original.expiresAt ? /* @__PURE__ */ jsx(DateCell, {
				date: row.original.expiresAt,
				ignoreAfterYears: 50
			}) : /* @__PURE__ */ jsx(TextCell, { children: "Never" });
		}
	},
	{
		...
		cell: ({ row }) => /* @__PURE__ */ jsx(DateCell, {
