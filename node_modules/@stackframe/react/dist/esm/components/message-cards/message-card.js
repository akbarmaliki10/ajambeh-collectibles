...
//#region src/components/message-cards/message-card.tsx
	...
	return /* @__PURE__ */ jsx(MaybeFullPage, {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				props.children,
				(props.primaryButtonText || props.secondaryButtonText) && /* @__PURE__ */ jsxs("div", {
					className: "flex justify-center gap-4 my-5",
					children: [props.secondaryButtonText && /* @__PURE__ */ jsx(Button, {
						variant: "secondary",
						onClick: props.secondaryAction,
						children: props.secondaryButtonText
					}), props.primaryButtonText && /* @__PURE__ */ jsx(Button, {
