...
function CredentialSignUp(props) {
	...
	const { register, handleSubmit, setError, formState: { errors }, clearErrors } = useForm({ resolver: yupResolver(yupObject({
		...
		...!props.noPasswordRepeat && { passwordRepeat: passwordSchema.nullable().oneOf([
			yup.ref("password"),
			"",
			null
	...
	const onSubmit = async (data) => {
		...
		try {
			...
			if (result.status === "error") setError("email", {
				type: "manual",
