...
function Inner(props) {
	...
	useEffect(() => {
		if (!props.noUpdateSelectedTeam && props.selectedTeam && !props.mockUser) runAsynchronouslyWithAlert(user?.setSelectedTeam(props.selectedTeam));
	}, [
		props.noUpdateSelectedTeam,
		props.selectedTeam,
		props.mockUser
	]);
	return /* @__PURE__ */ jsx(TeamSwitcher, {
		...
		onChange: async (team) => {
			...
			if (!props.noUpdateSelectedTeam) await user?.setSelectedTeam(team);
			if (props.urlMap) navigate(props.urlMap(team));
		}
	});
}
