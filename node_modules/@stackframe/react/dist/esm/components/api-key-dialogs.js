...
function CreateApiKeyDialog(props) {
	...
	useUser({ or: props.mockMode ? "return-null" : "redirect" });
	...
	const onSubmit = async (data) => {
		...
		try {
			...
			if (props.onKeyCreated) props.onKeyCreated(apiKey);
			reset();
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("select", {
							...
							...register("expiresIn"),
							children: Object.entries(expiresInOptions).map(([value, label]) => /* @__PURE__ */ jsx("option", {
								value,
								children: t(label)
							}, value))
						}),
...
//#endregion
export { CreateApiKeyDialog, ShowApiKeyDialog, expiresInOptions, neverInMs };
