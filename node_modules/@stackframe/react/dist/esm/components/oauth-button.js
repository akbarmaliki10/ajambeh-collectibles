...
//#region src/components/oauth-button.tsx
const iconSize = 22;
const changeColor = (c, value) => {
...
function OAuthButton({ provider, type, isMock = false, onAuthenticate }) {
  ...
  ` }), /* @__PURE__ */ jsx(SimpleTooltip, {
		...
		children: /* @__PURE__ */ jsxs(Button, {
			...
			disabled: isIframe,
			children: [!isMock && lastUsed === provider && /* @__PURE__ */ jsx("span", {
				className: "absolute -top-2 -right-2 bg-blue-500 text-white text-xs px-2 py-1 rounded-md",
				children: "last"
			}), /* @__PURE__ */ jsxs("div", {
				className: "flex items-center w-full gap-4",
				children: [style.icon, /* @__PURE__ */ jsx("span", {
					className: "flex-1",
					children: type === "sign-up" ? t("Sign up with {provider}", { provider: style.name }) : t("Sign in with {provider}", { provider: style.name })
				})]
			})]
		})
	})] });
