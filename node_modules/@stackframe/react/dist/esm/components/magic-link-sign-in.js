...
function MagicLinkSignIn() {
	...
	const { register, handleSubmit, setError, formState: { errors } } = useForm({ resolver: yupResolver(yupObject({ email: strictEmailSchema(t("Please enter a valid email")).defined().nonEmpty(t("Please enter your email")) })) });
	const onSubmit = async (data) => {
		...
		try {
			...
			if (KnownErrors.SignUpNotEnabled.isInstance(e)) setError("email", {
				type: "manual",
	...
	if (nonce) return /* @__PURE__ */ jsx(OTP, {
		nonce,
		onBack: () => setNonce(null)
	});
	else return /* @__PURE__ */ jsxs("form", {
		className: "flex flex-col items-stretch stack-scope",
