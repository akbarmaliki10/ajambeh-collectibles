...
import { Button, Select, SelectContent, SelectGroup, SelectItem, SelectLabel, SelectSeparator, SelectTrigger, SelectValue, Skeleton, Typography, cn } from "@stackframe/stack-ui";
		...
		onValueChange: (value) => {
			runAsynchronouslyWithAlert(async () => {
				...
				if (value !== "null-sentinel") {
					...
					if (!team) throw new StackAssertionError("Team not found, this should not happen");
				} else team = null;
				if (props.onChange) await props.onChange(team);
			});
		},
		children: [/* @__PURE__ */ jsx(SelectTrigger, {
			className: cn("stack-scope max-w-64", props.triggerClassName),
			children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Select team" })
		}), /* @__PURE__ */ jsxs(SelectContent, {
			className: "stack-scope",
			children: [
				selectedTeam ? /* @__PURE__ */ jsxs(SelectGroup, { children: [/* @__PURE__ */ jsx(SelectLabel, { children: /* @__PURE__ */ jsxs("div", {
					className: "flex items-center justify-between",
					children: [/* @__PURE__ */ jsx("span", { children: t("Current team") }), /* @__PURE__ */ jsx(Button, {
						variant: "ghost",
						size: "icon",
						className: "h-6 w-6",
						onClick: () => {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(TeamIcon, { team: selectedTeam }), /* @__PURE__ */ jsx(Typography, {
							className: "max-w-40 truncate",
							children: selectedTeam.displayName
						})]
					})
				})] }) : void 0,
				props.allowNull && /* @__PURE__ */ jsx(SelectGroup, { children: /* @__PURE__ */ jsx(SelectItem, {
					value: "null-sentinel",
					children: /* @__PURE__ */ jsxs("div", {
						className: "flex items-center gap-2",
						children: [/* @__PURE__ */ jsx(TeamIcon, { team: "personal" }), /* @__PURE__ */ jsx(Typography, {
							className: "max-w-40 truncate",
							children: props.nullLabel || t("No team")
						})]
					})
				}) }),
				teams?.length ? /* @__PURE__ */ jsxs(SelectGroup, { children: [/* @__PURE__ */ jsx(SelectLabel, { children: t("Other teams") }), teams.filter((team) => team.id !== selectedTeam?.id).map((team) => /* @__PURE__ */ jsx(SelectItem, {
					value: team.id,
					children: /* @__PURE__ */ jsxs("div", {
						className: "flex items-center gap-2",
						children: [/* @__PURE__ */ jsx(TeamIcon, { team }), /* @__PURE__ */ jsx(Typography, {
				...
				project.config.clientTeamCreationEnabled && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(SelectSeparator, {}), /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs(Button, {
					onClick: () => {
