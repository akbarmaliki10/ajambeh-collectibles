...
//#region src/components-page/account-settings/teams/team-member-list-section.tsx
function TeamMemberListSection(props) {
	const user = useUser({ or: "redirect" });
	const readMemberPermission = user.usePermission(props.team, "$read_members");
	const inviteMemberPermission = user.usePermission(props.team, "$invite_members");
	if (!readMemberPermission && !inviteMemberPermission) return null;
...
function MemberListSectionInner(props) {
	...
	return /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(Typography, {
		...
		children: /* @__PURE__ */ jsxs(Table, { children: [/* @__PURE__ */ jsx(TableHeader, { children: /* @__PURE__ */ jsxs(TableRow, { children: [/* @__PURE__ */ jsx(TableHead, {
			className: "w-[100px]",
			children: t("User")
		}), /* @__PURE__ */ jsx(TableHead, {
			className: "w-[200px]",
			children: t("Name")
		})] }) }), /* @__PURE__ */ jsx(TableBody, { children: users.map(({ id, teamProfile }, i) => /* @__PURE__ */ jsxs(TableRow, { children: [/* @__PURE__ */ jsx(TableCell, { children: /* @__PURE__ */ jsx(UserAvatar, { user: teamProfile }) }), /* @__PURE__ */ jsxs(TableCell, { children: [teamProfile.displayName && /* @__PURE__ */ jsx(Typography, { children: teamProfile.displayName }), !teamProfile.displayName && /* @__PURE__ */ jsx(Typography, {
