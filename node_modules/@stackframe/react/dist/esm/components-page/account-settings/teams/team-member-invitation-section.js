...
function MemberInvitationsSectionInvitationsList(props) {
	...
	return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(Table, {
		className: "mt-6",
		children: [/* @__PURE__ */ jsx(TableHeader, { children: /* @__PURE__ */ jsxs(TableRow, { children: [
		...
		] }) }), /* @__PURE__ */ jsxs(TableBody, { children: [invitationsToShow.map((invitation, i) => /* @__PURE__ */ jsxs(TableRow, { children: [
			/* @__PURE__ */ jsx(TableCell, { children: /* @__PURE__ */ jsx(Typography, { children: invitation.recipientEmail }) }),
			/* @__PURE__ */ jsx(TableCell, { children: /* @__PURE__ */ jsx(Typography, {
				variant: "secondary",
			...
			/* @__PURE__ */ jsx(TableCell, {
				...
				children: removeMemberPermission && /* @__PURE__ */ jsx(Button, {
		...
		] }, invitation.id)), invitationsToShow.length === 0 && /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsx(TableCell, {
			colSpan: 3,
...
function MemberInvitationSectionInner(props) {
	...
	const { register, handleSubmit, formState: { errors }, watch } = useForm({ resolver: yupResolver(yupObject({ email: strictEmailSchema(t("Please enter a valid email address")).defined().nonEmpty(t("Please enter an email address")) })) });
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Section, {
		...
		children: /* @__PURE__ */ jsxs("form", {
			...
			children: [
				...
				invitedEmail && /* @__PURE__ */ jsxs(Typography, {
					type: "label",
					variant: "secondary",
...
//#endregion
export { TeamMemberInvitationSection };
