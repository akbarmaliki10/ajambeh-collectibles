import { Separator, Switch, Typography } from "@stackframe/stack-ui";
...
function NotificationsPage() {
	...
	const notificationCategories = useUser({ or: "redirect" }).useNotificationCategories();
	return /* @__PURE__ */ jsxs(PageLayout, { children: [/* @__PURE__ */ jsx(Separator, {}), /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("div", {
		...
		}), notificationCategories.map((category) => /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				!category.canDisable && /* @__PURE__ */ jsx(Typography, {
					variant: "secondary",
					type: "footnote",
