...
function PasswordSection(props) {
	...
	const { register, handleSubmit, setError, formState: { errors }, clearErrors, reset } = useForm({ resolver: yupResolver(yupObject({
		oldPassword: user.hasPassword ? passwordSchema.defined().nonEmpty(t("Please enter your old password")) : yupString(),
		newPassword: passwordSchema.defined().nonEmpty(t("Please enter your password")).test({
		...
		newPasswordRepeat: yupString().nullable().oneOf([
			yup.ref("newPassword"),
			"",
			null
	...
	return /* @__PURE__ */ jsx(Section, {
		...
		children: /* @__PURE__ */ jsx("div", {
			...
			children: !changingPassword ? hasValidEmail ? /* @__PURE__ */ jsx(Button, {
				variant: "secondary",
