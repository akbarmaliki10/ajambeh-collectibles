...
function OAuthCallback({ fullPage }) {
	...
	useEffect(() => runAsynchronously(async () => {
		...
		if (!hasRedirected && (callbackError == null || envVars.NODE_ENV === "production")) await app.redirectToSignIn({ noRedirectBack: true });
	}), []);
	useEffect(() => {
	...
	return /* @__PURE__ */ jsx(MaybeFullPage, {
		...
		children: /* @__PURE__ */ jsxs("div", {
			className: cn("text-center justify-center items-center stack-scope flex flex-col gap-4 max-w-[380px]", fullPage ? "p-4" : "p-0"),
			children: [
				/* @__PURE__ */ jsx("div", {
