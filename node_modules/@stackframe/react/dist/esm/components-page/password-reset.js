...
function PasswordResetForm(props) {
	...
	const { register, handleSubmit, formState: { errors }, clearErrors } = useForm({ resolver: yupResolver(yupObject({
	...
	if (finished) return /* @__PURE__ */ jsx(PredefinedMessageCard, {
		type: "passwordReset",
		fullPage: !!props.fullPage
	});
	if (resetError) return /* @__PURE__ */ jsx(MessageCard$1, {
	...
	return /* @__PURE__ */ jsx(MaybeFullPage, {
		...
		children: /* @__PURE__ */ jsxs("div", {
			className: cn("flex flex-col items-stretch max-w-[380px] flex-basis-[380px]", props.fullPage ? "p-4" : "p-0"),
...
function PasswordReset({ searchParams, fullPage = false }) {
	...
	const invalidJsx = /* @__PURE__ */ jsx(MessageCard$1, {
		...
		fullPage,
		children: /* @__PURE__ */ jsx(Typography, { children: t("Please double check if you have the correct password reset link.") })
	});
	const expiredJsx = /* @__PURE__ */ jsx(MessageCard$1, {
		title: t("Expired Password Reset Link"),
		fullPage,
		children: /* @__PURE__ */ jsx(Typography, { children: t("Your password reset link has expired. Please request a new password reset link from the login page.") })
	});
	const usedJsx = /* @__PURE__ */ jsx(MessageCard$1, {
		title: t("Used Password Reset Link"),
		fullPage,
		children: /* @__PURE__ */ jsx(Typography, { children: t("This password reset link has already been used. If you need to reset your password again, please request a new password reset link from the login page.") })
	});
	...
	return /* @__PURE__ */ jsx(PasswordResetForm, {
		code,
		fullPage
	});
}
