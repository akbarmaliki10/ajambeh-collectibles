...
//#region src/components-page/auth-page.tsx
function AuthPage(props) {
	return /* @__PURE__ */ jsx(Suspense, {
		fallback: /* @__PURE__ */ jsx(Fallback, { ...props }),
		children: /* @__PURE__ */ jsx(Inner, { ...props })
	});
}
...
function Inner(props) {
	...
	useEffect(() => {
		if (props.automaticRedirect && user && !props.mockProject) runAsynchronously(props.type === "sign-in" ? stackApp.redirectToAfterSignIn({ replace: true }) : stackApp.redirectToAfterSignUp({ replace: true }));
	}, [
		user,
		props.mockProject,
		stackApp,
	...
	if (props.type === "sign-up" && !project.config.signUpEnabled) return /* @__PURE__ */ jsx(PredefinedMessageCard, {
		type: "signUpDisabled",
		fullPage: props.fullPage
	});
	...
	return /* @__PURE__ */ jsx(MaybeFullPage, {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				(hasOAuthProviders || hasPasskey) && /* @__PURE__ */ jsxs("div", {
					className: "gap-4 flex flex-col items-stretch stack-scope",
					children: [hasOAuthProviders && /* @__PURE__ */ jsx(OAuthButtonGroup, {
						type: props.type,
				...
				project.config.credentialEnabled && project.config.magicLinkEnabled ? /* @__PURE__ */ jsxs(Tabs, {
					defaultValue: props.firstTab || "magic-link",
					children: [
						/* @__PURE__ */ jsxs(TabsList, {
							className: cn("w-full mb-2", { "flex-row-reverse": props.firstTab === "password" }),
						...
						/* @__PURE__ */ jsx(TabsContent, {
							value: "magic-link",
							children: /* @__PURE__ */ jsx(MagicLinkSignIn, {})
						}),
						/* @__PURE__ */ jsx(TabsContent, {
							value: "password",
							children: props.type === "sign-up" ? /* @__PURE__ */ jsx(CredentialSignUp, { noPasswordRepeat: props.noPasswordRepeat }) : /* @__PURE__ */ jsx(CredentialSignIn, {})
						})
					]
				}) : project.config.credentialEnabled ? props.type === "sign-up" ? /* @__PURE__ */ jsx(CredentialSignUp, { noPasswordRepeat: props.noPasswordRepeat }) : /* @__PURE__ */ jsx(CredentialSignIn, {}) : project.config.magicLinkEnabled ? /* @__PURE__ */ jsx(MagicLinkSignIn, {}) : !(hasOAuthProviders || hasPasskey) ? /* @__PURE__ */ jsx(Typography, {
					variant: "destructive",
					className: "text-center",
					children: t("No authentication method enabled.")
				}) : null,
				props.extraInfo && /* @__PURE__ */ jsx("div", {
					className: cn("flex flex-col items-center text-center text-sm text-gray-500", {
