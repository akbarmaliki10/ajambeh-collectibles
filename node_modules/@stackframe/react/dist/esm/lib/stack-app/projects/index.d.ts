...
//#region src/lib/stack-app/projects/index.d.ts
/**
...
type AdminProject = {
   ...
   */
  pushConfig(this: AdminProject, config: EnvironmentConfigOverrideOverride, options: PushConfigOptions): Promise<void>;
  /**
   ...
   */
  updatePushedConfig(this: AdminProject, config: EnvironmentConfigOverrideOverride): Promise<void>;
  /**
...
declare function adminProjectCreateOptionsToCrud(options: AdminProjectCreateOptions): AdminUserProjectsCrud["Server"]["Create"];
//#endregion
