...
//#region src/lib/stack-app/apps/interfaces/server-app.d.ts
...
type StackServerApp<HasTokenStore extends boolean = boolean, ProjectId extends string = string> = ({
  ...
  itemId: string;
  customCustomerId: string;
}], ServerItem, false> & AsyncStoreProperty<"products", [options: CustomerProductsRequestOptions], CustomerProductsList, true> & StackClientApp<HasTokenStore, ProjectId>);
...
//#endregion
export { StackServerApp, StackServerAppConstructor, StackServerAppConstructorOptions };
