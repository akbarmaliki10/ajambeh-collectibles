...
//#region src/lib/stack-app/apps/implementations/common.d.ts
...
type AppLike = {
  [stackAppInternalsSymbol]: {
    getConstructorOptions: () => any;
  };
};
declare function resolveConstructorOptions<T extends {
  inheritsFrom?: AppLike;
}>(options: T): T & {
...
declare const defaultBaseUrl = "https://api.stack-auth.com";
declare const defaultAnalyticsBaseUrl = "https://r.stack-auth.com";
