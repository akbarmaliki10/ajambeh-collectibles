...
//#region src/lib/stack-app/connected-accounts/index.d.ts
type Connection = {
  /**
   * @deprecated Use `provider` instead. This field returns the provider for backward compatibility.
   */
  id: string; /** Provider config ID (e.g., "google", "github") */
  provider: string; /** Account ID from the OAuth provider (e.g., Google user ID) */
...
type OAuthConnection = {
  ...
  getAccessToken(options?: {
    ...
    accessToken: string;
  }, KnownErrors["OAuthAccessTokenNotAvailable"]>>;
  /**
 ...
 */
type DeprecatedOAuthConnection = {
...
//#endregion
export { Connection, DeprecatedOAuthConnection, OAuthConnection };
