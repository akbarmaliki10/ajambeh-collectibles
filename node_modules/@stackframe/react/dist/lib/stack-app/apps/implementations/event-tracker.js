...
var EventTracker = class {
	constructor(deps) {
		...
		this._deps = deps;
		this._sessionReplaySegmentId = (0, __session_replay_js.generateUuid)();
	}
	start() {
