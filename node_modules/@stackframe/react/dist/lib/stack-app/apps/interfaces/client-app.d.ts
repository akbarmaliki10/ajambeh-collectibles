import { AsyncStoreProperty, AuthLike, GetCurrentPartialUserOptions, GetCurrentUserOptions, HandlerUrlOptions, HandlerUrls, OAuthScopesOnSignIn, RedirectMethod, RedirectToOptions, ResolvedHandlerUrls, TokenStoreInit, stackAppInternalsSymbol } from "../../common.js";
import { CustomerInvoicesList, CustomerInvoicesRequestOptions, CustomerProductsList, CustomerProductsRequestOptions, Item } from "../../customers/index.js";
import { ProjectCurrentUser, SyncedPartialUser, TokenPartialUser } from "../../users/index.js";
import { Project } from "../../projects/index.js";
import { AnalyticsOptions } from "../implementations/session-replay.js";
import { KnownErrors } from "@stackframe/stack-shared";
import { CurrentUserCrud } from "@stackframe/stack-shared/dist/interface/crud/current-user";
import { Result } from "@stackframe/stack-shared/dist/utils/results";

//#region src/lib/stack-app/apps/interfaces/client-app.d.ts
...
}], Item, false> & AsyncStoreProperty<"products", [options: CustomerProductsRequestOptions], CustomerProductsList, true> & AsyncStoreProperty<"invoices", [options: CustomerInvoicesRequestOptions], CustomerInvoicesList, true> & { [K in `redirectTo${Capitalize<keyof Omit<HandlerUrls, 'handler' | 'oauthCallback'>>}`]: (options?: RedirectToOptions) => Promise<void> } & AuthLike<HasTokenStore extends false ? {
  tokenStore: TokenStoreInit;
} : {
  tokenStore?: TokenStoreInit;
}>);
...
//#endregion
export { StackClientApp, StackClientAppConstructor, StackClientAppConstructorOptions, StackClientAppJson };
