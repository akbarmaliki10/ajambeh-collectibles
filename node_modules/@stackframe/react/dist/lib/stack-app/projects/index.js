...
function adminProjectUpdateOptionsToCrud(options) {
	return {
		...
		config: {
			...
			email_config: options.config?.emailConfig && (options.config.emailConfig.type === "shared" ? { type: "shared" } : {
				type: "standard",
...
//#endregion
exports.adminProjectCreateOptionsToCrud = adminProjectCreateOptionsToCrud;
exports.adminProjectUpdateOptionsToCrud = adminProjectUpdateOptionsToCrud;
