import { createWhatsAppUrl, whatsappDefaultMessage } from '../lib/whatsapp';
    ...
    <section className="relative min-h-[100vh] lg:min-h-[870px] flex items-center justify-center overflow-hidden px-4 md:px-6 pt-24 pb-12 mesh-gradient">
      <div className="relative z-10 max-w-4xl text-center">
        ...
        <p className="text-on-surface-variant text-base md:text-xl max-w-2xl mx-auto mb-8 md:mb-10 leading-relaxed font-light">
          Temukan kartu Pokemon langka, edisi terbatas, dan aset koleksi premium yang telah dijamin keasliannya!
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full">
          ...
          <a
            className="px-8 py-4 bg-transparent border border-primary/30 hover:bg-primary/10 text-primary font-bold rounded-lg transition-all w-full sm:w-auto flex items-center justify-center gap-2"
            href={createWhatsAppUrl(whatsappDefaultMessage)}
            target="_blank"
